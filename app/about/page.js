        ...
        <div className="w-full h-[90%]  flex md:flex-row flex-col justify-evenly mt-32 md:mt-10 items-center">
          <div className="flex flex-col w-full md:w-[60%] justify-center items-center ">
            <div className="w-full">
              ...
              <p className="text-white  md:text-xl mt-4" style={poppins.style}>Whispra is built for people dealing with anxiety, stress, or <br/> loneliness. It connects individuals with listeners who truly care, and <br/> provides a safe, anonymous environment for meaningful <br/> conversations.</p>
            </div>
            <div className="w-full flex flex-col justify-start items-start mt-3">
              <div className="w-full flex items-center justify-start">
                ...
                />
                <h2 className="text-white text-2xl font-bold" style={baloo.style}>Empathy & kindness first</h2>
                  </div>
                    <div className="w-full flex items-center justify-start">
                <Image
                  src="/privacy.png"
                  ...
                  className="drop-shadow-[10px_10px_20px_rgba(0,0,0,0.5)]"
                />
                <h2 className="text-white text-2xl font-bold" style={baloo.style}>Privacy and safety</h2>
              </div>
               <div className="w-full flex items-center justify-start">
                <Image
                  src="/chat.png"
                  ...
                  className="drop-shadow-[10px_10px_20px_rgba(0,0,0,0.5)]"
                />
                <h2 className="text-white text-2xl font-bold" style={baloo.style}>Real conversations that heal</h2>
              </div>
            </div>
          </div>
